...
| 结果 | 条数 | 占比 |
|---|---|---|
| 一致（模型也判 reject） | 7 | 8.5% |
| 不一致（模型判 confirmed） | 75 | 91.5% |
...
|---|---|---|---|---|---|---|---|
| 答案题 | 67 | 6 | 61 | 0 | 16 | 0 | 0 |
| 拒答题 | 15 | 1 | 14 | 0 | 4 | 0 | 0 |
| 跨文档题 | 28 | 3 | 25 | 0 | 2 | 0 | 0 |
...
|---|---|
| direct_snippet | 79 |
| within_chunk_outside_snippet | 7 |
| faithful_paraphrase | 38 |
| unsupported | 6 |
| 合计答案点 | 130 |
...
| 37 | mixed-028 | 争议 | 跨文档 | reject | reject |
...
| 76 | noanswer-052 | 争议 | 拒答 | reject | reject |
